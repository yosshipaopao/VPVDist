...
<div class='drawer'>
	...
	<div class='drawer-content flex flex-col'>
		<div class='w-full navbar backdrop-blur-3xl shadow border-b border-b-primary px-6 sticky top-0 z-40'>
			...
			<div class='dropdown dropdown-end'>
				...
				<ul tabindex='0' class='menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow-xl rounded-box w-52 bg-base-300'>
					{#if $page.data.session?.user}
						<img src={$page.data.session.user.image} alt='user icon' class='w-20 h-20 rounded-full mx-auto' />
						...
						<li><a href='/user/{$page.data.session.user.id}'>My Profile</a></li>
						<li>
